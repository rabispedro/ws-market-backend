package com.wsmarket.wsmarketbackend.services.validations.utils;
...
public class DocumentUtil {
	...
	public static boolean isValidCNPJ(final String cnpj) {
		...
		final Integer ditig2 = calculate(cnpj.substring(0, 12) + digit1, weightCNPJ);

		return cnpj.equals(cnpj.substring(0, 12) + digit1.toString() + ditig2.toString());
	}
}
